...
\begin{frame}
	...
	measures the average number of bits needed to identify an event drawn from the set if a coding scheme used for the set
...
\subsection{Donsker-Varadhan Variational Formula}
	...
	\begin{frame}
		\frametitle{Existence of supremum in Donsker-Varadhan variational representation}
